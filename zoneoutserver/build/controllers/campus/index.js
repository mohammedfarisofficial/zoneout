...
exports.getCampusUsersDetails = exports.loadOneCampus = exports.loadCampus = void 0;
...
const getCampusUsersDetails = async (req, res) => {
    try {
        const { userId } = req.user;
        const user = await (0, auth_helper_1.getUser)(userId, access_levels_1.BASIC_ACCESS_LEVEL);
        const campusUsers = await (0, campus_helper_1.getCampusUsers)(user.campus, access_levels_1.BASIC_ACCESS_LEVEL);
...
exports.getCampusUsersDetails = getCampusUsersDetails;
